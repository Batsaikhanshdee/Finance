...
var uiController = (function() {
  var DOMstrings = {
    ...
    epxpensePercentageLabel: ".item__percentage",
  ...
  return {
    ...
    displayPercentages: function(allPercentages){
      ...
      var elements = document.querySelectorAll(DOMstrings.epxpensePercentageLabel);
      // Элемент бүрийн хувьд зарлагийн хувийг массиваас шивж оруулах
  ...
  var setupEventListeners = function() {
    ...
    document.querySelector(DOM.containerDiv).addEventListener('click', function(event){
      ...
      if(id){
        ...
        // Үлдэгдэл тооцоог шинчилж харуулна
        // Төсвийг шинээр тооцоолоод дэлгэцэнд үзүүлнэ.
        updateTusuv();
      }
    });
